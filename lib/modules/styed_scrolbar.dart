  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (_, BoxConstraints constraints) {
        ...
        // Handle color
        Color handleColor = widget.handleColor ?? (Get.isDarkMode ? const Color(0xff909f9c).withOpacity(.2) : const Color(0xff909f9c));
        // Track color
        Color trackColor =
            widget.trackColor ?? (Get.isDarkMode ? const Color(0xff909f9c).withOpacity(.1) : const Color(0xff909f9c).withOpacity(.3));
